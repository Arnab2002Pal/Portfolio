...
const TimeLine = () => {
    return (
        <div className='h-screen flex flex-col items-center gap-5 md:gap-10 mt-24 md:mt-0 '>
            <div className={`${mainFont.className} w-full flex-col justify-center text-center items-center h-20`}>
                <h3 className="text-2xl md:text-5xl font-semibold">Milestones of <span className={`${highlightFont.className} text-white `}>Growth</span></h3>
            ...
            <div className='w-[55vw] overflow-y-auto lg:overflow-hidden mb-10'>
                <ol className="relative border-s border-gray-200 dark:border-gray-700 mx-2 ">
                    <li className="mb-7 ms-4">
                        ...
                        {/* <li>- Engineered and maintained an HR domain chat-based web application using Elixir for backend programming.</li>
